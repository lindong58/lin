...
{
LogPrintf("request getdifficulty>>>>>>>>>>>>>>>>>>>>>>");
return 1.0;
/*
...
UniValue blockheaderToJSON(const CBlockIndex* blockindex)
{
    ...
    if (blockindex->pprev)
        result.push_back(Pair("previousblockhash", uint256S("0x000faaaaaaaa4d0a398161ffc163c503763b1f4360639393e0e4c8e300e0caec").GetHex()));
