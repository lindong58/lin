...
!define MUI_ICON "/root/btcs/v3/btcsv3/share/pixmaps/bitcoin.ico"
!define MUI_WELCOMEFINISHPAGE_BITMAP "/root/btcs/v3/btcsv3/share/pixmaps/nsis-wizard.bmp"
!define MUI_HEADERIMAGE
!define MUI_HEADERIMAGE_RIGHT
!define MUI_HEADERIMAGE_BITMAP "/root/btcs/v3/btcsv3/share/pixmaps/nsis-header.bmp"
...
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "/root/btcs/v3/btcsv3/share/pixmaps/nsis-wizard.bmp"
...
OutFile /root/btcs/v3/btcsv3/bitcoin-${VERSION}-win-setup.exe
!if "" == "64"
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File /root/btcs/v3/btcsv3/release/bitcoin-qt
    File /oname=COPYING.txt /root/btcs/v3/btcsv3/COPYING
    File /oname=readme.txt /root/btcs/v3/btcsv3/doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File /root/btcs/v3/btcsv3/release/bitcoind
    File /root/btcs/v3/btcsv3/release/bitcoin-cli
    SetOutPath $INSTDIR\doc
    File /r /root/btcs/v3/btcsv3/doc\*.*
    SetOutPath $INSTDIR
